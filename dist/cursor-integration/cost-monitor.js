...
exports.HotelCommonCostMonitor = exports.AnthropicCostCalculator = void 0;
...
class AnthropicCostCalculator {
    ...
    static INPUT_COST_PER_M = 3.0; // $3/1M tokens
    static OUTPUT_COST_PER_M = 15.0; // $15/1M tokens
    // Cursor 20%マークアップ
    static CURSOR_MARKUP = 0.20;
    static calculateDirectCost(inputTokens, outputTokens) {
    ...
    static calculateProjectedMonthlyCost(dailyUsage) {
        return dailyUsage.totalCost * 30;
    }
    static calculateYearlySavings(monthlyUsage) {
        return monthlyUsage.savedCost * 12;
    }
}
exports.AnthropicCostCalculator = AnthropicCostCalculator;
/**
 * コスト監視・管理システム
 */
...
exports.HotelCommonCostMonitor = HotelCommonCostMonitor;
// テスト実行部分
