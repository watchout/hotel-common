...
exports.integrateAiConciergeFeature = integrateAiConciergeFeature;
const response_tree_routes_1 = __importDefault(require("../../routes/systems/member/response-tree.routes"));
 ...
 * @param server 統合サーバー
 */
function integrateAiConciergeFeature(server) {
    try {
        // レスポンスツリーAPIルートを追加
        server.addRouter('/api/v1/ai', response_tree_routes_1.default);
        console.log(`
🤖 AIコンシェルジュ機能統合完了！
