...
const vue_2 = require("@iconify/vue");
...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props, { attrs, emit }) {
        // 完全修飾アイコン名
        const iconName = (0, vue_1.computed)(() => (0, iconLoader_1.getFullIconName)(props.name, props.set));
        // サイズ（px）
        const sizeInPixels = (0, vue_1.computed)(() => getSizeInPixels(props.size));
        // カラー値
        const colorValue = (0, vue_1.computed)(() => getColorValue(props.color));
        // スタイル
        const iconStyle = (0, vue_1.computed)(() => ({
