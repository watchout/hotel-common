...
const device_routes_1 = __importDefault(require("../routes/systems/saas/device.routes"));
/**
 * 統合サーバーの更新スクリプト
 * デバイス管理APIを追加
 */
// 統合サーバーのインスタンスを作成
const server = new integration_server_1.HotelIntegrationServer();
// デバイス管理APIルーターを追加
server.addRouter('', device_routes_1.default);
console.log(`
